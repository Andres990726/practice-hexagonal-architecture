...
// @Transactional
public class ProyectoParcialApplication {
...
// docente.getObjDireccion().getDireccionResidencia());
...
// Iterable<DireccionEntity> listaDirecciones =
// this.servicioBDDirecciones.findAll();
...
// System.out.println("Docente: "+ direccion.getObjPersona().getNombres() + " "+
// direccion.getObjPersona().getApellidos());
// }
// }

// private void listarPublicaciones(){
// Iterable<PublicacionEntity> listaPublicaciones =
// this.servicioBDPublicaciones.findAll();
...
// PublicacionEntity objPublicacionAgregado =
// servicioBDPublicaciones.save(publicacion1);
